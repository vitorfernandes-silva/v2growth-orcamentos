...
import { formatBRL } from "@/data/scaroniProposalData";
        ...
        <div className="bg-slate-900/60 border-2 border-primary rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-[0_0_40px_rgba(25,61,235,0.2)]">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <span className="text-xs text-slate-400 font-medium">
              Especialmente analisada para o Grupo Scaroni
            </span>
          </div>

          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
            Nossa recomendação para o Grupo Scaroni
          </h2>
            ...
            <div className="md:col-span-7 space-y-4">
              <div className="flex items-baseline gap-3">
                <h3 className="text-2xl sm:text-3xl font-bold text-white">
                  Plano Growth <span className="text-secondary">— 6 meses</span>
                </h3>
              </div>
              ...
              <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                ...
                <strong className="text-white">
                  É o ponto de equilíbrio ideal entre aquisição ativa (Meta e Google Ads), presença em conteúdo, Landing Pages de lançamentos, acompanhamento estratégico e análise contínua dos resultados comerciais.
                </strong>
              </p>
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-slate-300 pt-2">
                <li className="flex items-center gap-2">
                  ...
                  Meta Ads + TikTok Ads + Google Ads integrados
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-400 shrink-0" />
                  1 Landing Page mensal para lançamentos imobiliários
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-400 shrink-0" />
                  Reunião quinzenal e Dashboard executivo
                </li>
              </ul>
            </div>
            ...
            <div className="md:col-span-5 bg-slate-950/80 border border-slate-800 rounded-2xl p-6 text-center space-y-4">
              <div>
                ...
                <span className="text-3xl font-black text-emerald-400 block mt-0.5">
                  R$ 1.890,00<span className="text-xs text-slate-400 font-normal">/mês</span>
                </span>
              </div>
              ...
              <div className="pt-3 border-t border-slate-800/80">
                <div className="flex justify-between text-xs text-slate-300 mb-1">
                  ...
                  <strong className="text-white">R$ 11.340,00</strong>
                </div>
