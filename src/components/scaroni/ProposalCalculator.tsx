    ...
    <section className="py-24 max-w-7xl mx-auto px-6" id="simulador">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-slate-400 text-sm sm:text-base mt-4 leading-relaxed">
          Escolha o plano, o período e a forma de pagamento. O valor total e os descontos serão
          atualizados automaticamente com transparência absoluta.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="bg-slate-900/30 border border-slate-800/80 rounded-3xl p-6 sm:p-7">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              {planList.map((p) => {
                ...
                return (
                  ...
                  >
                    {isGrowth && (
                      <span className="absolute top-2.5 right-2.5 text-[9px] uppercase tracking-wider font-bold text-secondary bg-primary/20 border border-primary/40 px-2 py-0.5 rounded-full">
                        Recomendado
                      </span>
                    )}
                    ...
                    <p className="text-[11px] text-slate-400 mb-3 min-h-[30px] line-clamp-2">
                      {p.description}
                    </p>
            ...
            {planId === "growth" && (
              <p className="text-xs text-secondary/90 mt-3.5 flex items-center gap-1.5 font-medium">
                ...
                Plano recomendado para a operação do Grupo Scaroni
              </p>
            )}
          </div>
          ...
          {/* ETAPA 3: ESCOLHA A FORMA DE PAGAMENTO */}
          <div className="bg-slate-900/30 border border-slate-800/80 rounded-3xl p-6 sm:p-7">
            <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-slate-800/70">
              <span className="w-6 h-6 rounded-full bg-primary/20 text-secondary text-xs font-bold flex items-center justify-center">
                3
          ...
          <div className="bg-slate-900/30 border border-slate-800/80 rounded-3xl p-6 sm:p-7">
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-800/70">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="text-lg font-bold text-white">Você indicou alguém?</h3>
              </div>
            ...
            <p className="text-xs text-slate-400 mb-5 leading-relaxed">
              Se você indicar uma empresa ou pessoa para a V2 Growth e essa indicação resultar em um
              novo contrato, você recebe um desconto adicional na sua contratação.
            </p>
            ...
            <div className="space-y-3.5 mb-6 text-sm">
              ...
              {calc.referralDiscountAmount > 0 && (
                <div className="flex justify-between items-center text-emerald-400 bg-emerald-500/10 p-2.5 rounded-xl border border-emerald-500/20">
                  <div>
                    <span className="font-semibold block text-xs">
                      Desconto por indicação ({Math.round(calc.referralOption.discountRate * 100)}%)
                    </span>
                    <span className="text-[10px] text-emerald-400/80">
              ...
              <div className="flex justify-between items-center text-slate-300 pt-2 border-t border-slate-800/60">
                <span className="font-medium">Setup & Implantação</span>
